...
#	Modified: T.P. Boyle 07/2024: Shortened parameter names for smaller packet sizes, added m_sensor_type, m_cal
#
...
print(m_sensorName, "temp", round(tmp117.temperature,2), "m_meter_id", m_meterID, "m_sensor_location", m_sensorLoc, "m_sensor_type","tmp117", "m_cal",1)

...
History
	...
	Modified: T.P. Boyle 01/2025 - Added sensor_type for metrics and AWS achitecture, revised algorithm
		for Tenney env. chamber
	Modified: T.P. Boyle 01/2025 - modified slope to work with RSL CSZ env. chamber
...
data_json = open('/home/meso3/scripts/picarro_msg.json')			# read most recent picarro packet

while os.path.getsize('/home/meso3/scripts/picarro_msg.json') < 600:		# stall program until picarro message file exists

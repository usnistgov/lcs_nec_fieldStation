...
dict = {"epoch": int(time.time()), "topic": MQTT_TOPIC, "duty_cycle": FAN_SPEED, "m_sensor_type":"emc2101","stn_id":os.getenv("STN_NAME"),"stn_loc":os.getenv("STN_LOC")}	# create dict with packet info

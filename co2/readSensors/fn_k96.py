...
'''
	History: Basis courtesy of Cory Martin and Ning Zeng
		...
		Modified: T.P.Boyle 12/2024 - Removed extra parameters to make a smaller packet size for debugging sensors
...
def readSensor(sensorName):
	...
	units_s16 = [0.1, 1, 1, 0.1, 0.01, 0.01, 0.01, 0.01, 0.01, 0.01]

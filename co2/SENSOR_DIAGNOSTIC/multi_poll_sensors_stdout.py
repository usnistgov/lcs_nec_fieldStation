#!/usr/bin/env python3
# multi_poll_sensors_stdout.py

'''
Used for batch calibration purposes. Reads 10 K96s, stamps with epoch time, and prints measurements to stdout
- Primarily used for doing time-syncing

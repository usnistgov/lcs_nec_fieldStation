...
python3 /home/meso3/co2/calibrateSys/run_calibration_switcher.py 1 $CAL_TIME cl/raw/$STN_OWNER/$STN_LOC/$STN_NAME/cal_val1 $TANK_CONC_400>
sleep 5

# run calibration, valve 2, 600ppm cylinder
python3 /home/meso3/co2/calibrateSys/run_calibration_switcher.py 2 $CAL_TIME cl/raw/$STN_OWNER/$STN_LOC/$STN_NAME/cal_val2 $TANK_CONC_600>
sleep 5
...
output=$(python3 combineJsons.py temp_cal_400.json temp_cal_600.json temp_fan_reduce.json temp_fan_increase.json cl/raw/$STN_OWNER/$STN_L>

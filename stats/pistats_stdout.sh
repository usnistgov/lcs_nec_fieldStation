...
json="{\"epoch\": $epoch, \"topic\": \"$MQTT_TOPIC\", \"cpu\": { \"idle\": $cpuidl, \"iowait\": $cpuio, \"sys\": $cpusys}, \"memory\": { \"total\": $totmem, \"used\": $usemem, \"free\": $freemem }, \"cputemp\": $cputemp, \"m_sensor_type\":\"system\", \"stn_id\":\"$STN_NAME\", \"stn_loc\":\"$STN_LOC\", \"pkt_type\":\"pistats\"}"
